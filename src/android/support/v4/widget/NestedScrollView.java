...
public class NestedScrollView
  extends FrameLayout
  implements CoordinatorLayout.LayoutParams, ViewCompat.ViewCompatImpl, ScrollingView
{
    ...
    while (k < i1)
    {
      ...
      if (paramInt1 < i2)
      {
        ...
        if (n < paramInt2)
        {
          ...
          {
            if ((!paramBoolean) || (n >= localObject2.getTop()))
            {
              n = j;
              if (!paramBoolean)
              {
                n = j;
                if (i2 <= localObject2.getBottom()) {}
              }
            }
            else
            {
  ...
  protected int computeScrollDeltaToGetChildRectOnScreen(Rect paramRect)
  {
    ...
    if ((bottom > m) && (top > j))
    {
      ...
      i = Math.min(i, localView.getBottom() + bottomMargin - k);
    }
    do
    {
      do
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if (mEdgeGlowTop != null)
    {
      ...
      if (!mEdgeGlowTop.isFinished())
      {
        ...
        {
          k = n - (getPaddingLeft() + getPaddingRight());
          m = 0 + getPaddingLeft();
        }
        i1 = i;
        n = j;
      ...
      if (!mEdgeGlowBottom.isFinished())
      {
        ...
        i = i1;
        k = 0;
        i2 = Math.max(getScrollRange(), i4) + i1;
        if ((Build.VERSION.SDK_INT < 21) || (getClipToPadding()))
        {
  ...
  {
    if (((paramMotionEvent.getSource() & 0x2) != 0) && (paramMotionEvent.getAction() == 8) && (!mIsBeingDragged))
    {
  ...
  boolean overScrollByCompat(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, boolean paramBoolean)
  {
    ...
    paramInt7 += paramInt5;
    paramInt4 = -paramInt1;
    paramInt5 = paramInt1 + paramInt6;
    if (paramInt3 > paramInt7)
    {
      paramInt1 = paramInt7;
      paramBoolean = true;
    }
    else if (paramInt3 < paramInt8)
    {
      paramInt1 = paramInt8;
      paramBoolean = true;
    }
  ...
  {
    mParentHelper.onNestedScrollAccepted(paramView, paramInt);
