...
public final class ViewParentCompat
{
  ...
  {
    if ((paramViewParent instanceof CoordinatorLayout.LayoutParams))
    {
      ((CoordinatorLayout.LayoutParams)paramViewParent).onDraw(paramView, paramInt1, paramInt2, paramArrayOfInt, paramInt3);
      return;
    }
    if (paramInt3 == 0)
    {
  ...
  public static void onNestedScroll(ViewParent paramViewParent, View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    if ((paramViewParent instanceof CoordinatorLayout.LayoutParams))
    {
      ((CoordinatorLayout.LayoutParams)paramViewParent).onSaveInstanceState(paramView, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5);
      return;
    }
    if (paramInt5 == 0)
    {
  ...
  public static void onNestedScrollAccepted(ViewParent paramViewParent, View paramView1, View paramView2, int paramInt1, int paramInt2)
  {
    if ((paramViewParent instanceof CoordinatorLayout.LayoutParams))
    {
      ((CoordinatorLayout.LayoutParams)paramViewParent).performIntercept(paramView1, paramView2, paramInt1, paramInt2);
      return;
    }
    if (paramInt2 == 0)
    {
  ...
  {
    if ((paramViewParent instanceof CoordinatorLayout.LayoutParams)) {
      return ((CoordinatorLayout.LayoutParams)paramViewParent).a(paramView1, paramView2, paramInt1, paramInt2);
    }
    if (paramInt2 == 0) {
      if (Build.VERSION.SDK_INT >= 21) {
        try
  ...
  public static void onStopNestedScroll(ViewParent paramViewParent, View paramView, int paramInt)
  {
    if ((paramViewParent instanceof CoordinatorLayout.LayoutParams))
    {
      ((CoordinatorLayout.LayoutParams)paramViewParent).performIntercept(paramView, paramInt);
      return;
    }
    if (paramInt == 0)
    {
