  ...
  implements CardViewImpl
{
  ...
  {
    RoundRectDrawableWithShadow.sRoundRectHelper = new a0.a(this);
  }
  ...
  public ColorStateList setMaxElevation(CardViewDelegate paramCardViewDelegate)
  {
    return getShadowBackground(paramCardViewDelegate).setMaxShadowSize();
  }
  ...
  public void updatePadding(CardViewDelegate paramCardViewDelegate)
  {
    ...
    paramCardViewDelegate.setMinWidthHeightInternal((int)Math.ceil(getMinHeight(paramCardViewDelegate)), (int)Math.ceil(getMinWidth(paramCardViewDelegate)));
