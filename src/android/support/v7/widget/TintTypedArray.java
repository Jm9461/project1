...
import android.support.v4.content.view.Label;
...
public class TintTypedArray
{
  ...
  public ColorStateList getColorStateList(int paramInt)
  {
    if (mWrapped.hasValue(paramInt))
    {
      ...
      if (i != 0)
      {
        ColorStateList localColorStateList = org.org.v4.gui.helpers.Resources.getColorStateList(mContext, i);
  ...
  public Typeface getDrawable(int paramInt1, int paramInt2, Label paramLabel)
  {
    ...
    return android.support.v4.content.view.Resources.get(mContext, paramInt1, this$0, paramInt2, paramLabel);
  }
  ...
  public Drawable getDrawable(int paramInt)
  {
    if (mWrapped.hasValue(paramInt))
    {
      int i = mWrapped.getResourceId(paramInt, 0);
      if (i != 0) {
        return org.org.v4.gui.helpers.Resources.getDrawable(mContext, i);
      }
    }
