  ...
  extends Object
{
  ...
  {
    getItem().playTogether(new Animator[] { ObjectAnimator.ofFloat(paramView, "translationX", new float[] { -paramView.getWidth(), 1.10624768E9F, -1.05486746E9F, 0.0F }), ObjectAnimator.ofFloat(paramView, "alpha", new float[] { 0.0F, 1.0F, 1.0F, 1.0F }) });
  }
}
