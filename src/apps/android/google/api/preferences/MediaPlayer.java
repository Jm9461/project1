  ...
  extends Object
{
  ...
  {
    getItem().playTogether(new Animator[] { ObjectAnimator.ofFloat(paramView, "alpha", new float[] { 0.0F, 1.0F }), ObjectAnimator.ofFloat(paramView, "translationX", new float[] { -paramView.getWidth() / 4, 0.0F }) });
  }
}
