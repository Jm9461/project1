  ...
  extends Object
{
  ...
  {
    getItem().playTogether(new Animator[] { ObjectAnimator.ofFloat(paramView, "alpha", new float[] { 1.0F, 0.0F }), ObjectAnimator.ofFloat(paramView, "translationX", new float[] { 0.0F, -paramView.getRight() }) });
  }
}
