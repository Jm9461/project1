  ...
  extends Object
{
  ...
  public void prepare(View paramView)
  {
    ...
    getItem().playTogether(new Animator[] { ObjectAnimator.ofFloat(paramView, "alpha", new float[] { 1.0F, 0.0F }), ObjectAnimator.ofFloat(paramView, "translationY", new float[] { 0.0F, i - j }) });
  }
}
