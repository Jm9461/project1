  ...
  extends Object
{
  ...
  {
    getItem().playTogether(new Animator[] { ObjectAnimator.ofFloat(paramView, "scaleX", new float[] { 0.1F, 0.475F, 1.0F }), ObjectAnimator.ofFloat(paramView, "scaleY", new float[] { 0.1F, 0.475F, 1.0F }), ObjectAnimator.ofFloat(paramView, "translationX", new float[] { paramView.getWidth() + paramView.getPaddingRight(), -48.0F, 0.0F }), ObjectAnimator.ofFloat(paramView, "alpha", new float[] { 0.0F, 1.0F, 1.0F }) });
  }
}
