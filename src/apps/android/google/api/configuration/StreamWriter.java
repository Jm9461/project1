  ...
  extends Object
{
  ...
  {
    getItem().playTogether(new Animator[] { ObjectAnimator.ofFloat(paramView, "scaleX", new float[] { 0.45F, 1.0F }), ObjectAnimator.ofFloat(paramView, "scaleY", new float[] { 0.45F, 1.0F }), ObjectAnimator.ofFloat(paramView, "alpha", new float[] { 0.0F, 1.0F }) });
  }
}
