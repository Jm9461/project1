...
import android.support.v4.view.animation.NoAnimation;
...
class Interpolators
{
  ...
  {
    public static final Interpolator INSTANCE = NoAnimation.create(PATH_INDETERMINATE_HORIZONTAL_RECT1_SCALE_X);
  ...
  {
    public static final Interpolator INSTANCE = NoAnimation.create(PATH_INDETERMINATE_HORIZONTAL_RECT1_TRANSLATE_X);
  ...
  {
    public static final Interpolator INSTANCE = NoAnimation.create(PATH_INDETERMINATE_HORIZONTAL_RECT2_SCALE_X);
  ...
  {
    public static final Interpolator INSTANCE = NoAnimation.create(PATH_INDETERMINATE_HORIZONTAL_RECT2_TRANSLATE_X);
  ...
  {
    public static final Interpolator INSTANCE = NoAnimation.create(PATH_TRIM_PATH_END);
  ...
  {
    public static final Interpolator INSTANCE = NoAnimation.create(PATH_TRIM_PATH_START);
