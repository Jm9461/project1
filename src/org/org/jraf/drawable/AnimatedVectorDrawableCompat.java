  ...
  implements Animatable
{
  ...
  private void setupAnimatorsForTarget(String paramString, Animator paramAnimator)
  {
    ...
    if (mAnimators == null)
    {
      ...
      mAnimatedVectorState.mTargetNameMap = new Label();
    }
  ...
  public void inflate(Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme)
  {
    ...
    while ((i != 1) && ((paramXmlPullParser.getDepth() >= j + 1) || (i != 3)))
    {
      if (i == 2)
      {
        ...
        {
          localObject1 = android.support.v4.content.view.Context.obtainAttributes(paramResources, paramTheme, paramAttributeSet, AndroidResources.styleable_AnimatedVectorDrawable);
  ...
  class AnimatedVectorDrawableDelegateState
    extends Drawable.ConstantState
  {
