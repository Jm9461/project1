...
import android.support.v4.content.view.Context;
import android.support.v4.content.view.b;
  ...
  extends VectorDrawableCommon
{
  ...
  public static VectorDrawableCompat create(android.content.res.Resources paramResources, int paramInt, Resources.Theme paramTheme)
  {
    Object localObject;
    if (Build.VERSION.SDK_INT >= 24)
    {
      localObject = new VectorDrawableCompat();
      mDelegateDrawable = android.support.v4.content.view.Resources.getDrawable(paramResources, paramInt, paramTheme);
  ...
  public static VectorDrawableCompat createFromXmlInner(android.content.res.Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme)
  {
  ...
  private void inflateInternal(android.content.res.Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme)
  {
  ...
  private void updateStateFromTypedArray(TypedArray paramTypedArray, XmlPullParser paramXmlPullParser)
  {
    VectorDrawableCompatState localVectorDrawableCompatState = mVectorState;
    VPathRenderer localVPathRenderer = mVPathRenderer;
    mTintMode = parseTintModeCompat(Context.getString(paramTypedArray, paramXmlPullParser, "tintMode", 6, -1), PorterDuff.Mode.SRC_IN);
    ColorStateList localColorStateList = paramTypedArray.getColorStateList(1);
    if (localColorStateList != null) {
      mTint = localColorStateList;
    }
    mAutoMirrored = Context.getNamedBoolean(paramTypedArray, paramXmlPullParser, "autoMirrored", 5, mAutoMirrored);
    mViewportWidth = Context.getNamedFloat(paramTypedArray, paramXmlPullParser, "viewportWidth", 7, mViewportWidth);
    mViewportHeight = Context.getNamedFloat(paramTypedArray, paramXmlPullParser, "viewportHeight", 8, mViewportHeight);
    if (mViewportWidth > 0.0F)
    {
      if (mViewportHeight > 0.0F)
      {
        ...
        if (mBaseWidth > 0.0F)
        {
          if (mBaseHeight > 0.0F)
          {
            localVPathRenderer.setAlpha(Context.getNamedFloat(paramTypedArray, paramXmlPullParser, "alpha", 4, localVPathRenderer.getAlpha()));
  ...
  public void inflate(android.content.res.Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet)
  {
    Drawable localDrawable = mDelegateDrawable;
    if (localDrawable != null)
    {
  ...
  public void inflate(android.content.res.Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme)
  {
    ...
    TypedArray localTypedArray = Context.obtainAttributes(paramResources, paramTheme, paramAttributeSet, AndroidResources.styleable_VectorDrawableTypeArray);
  ...
  public void setAutoMirrored(boolean paramBoolean)
  {
    ...
    if (localDrawable != null)
    {
      DrawableCompat.setTint(localDrawable, paramBoolean);
      return;
    }
    ...
    extends VectorDrawableCompat.VPath
  {
    ...
    public void inflate(android.content.res.Resources paramResources, AttributeSet paramAttributeSet, Resources.Theme paramTheme, XmlPullParser paramXmlPullParser)
    {
      if (!Context.get(paramXmlPullParser, "pathData")) {
        return;
      }
      paramResources = Context.obtainAttributes(paramResources, paramTheme, paramAttributeSet, AndroidResources.styleable_VectorDrawableClipPath);
    ...
    extends VectorDrawableCompat.VPath
  {
    ...
    private void updateStateFromTypedArray(TypedArray paramTypedArray, XmlPullParser paramXmlPullParser, Resources.Theme paramTheme)
    {
      ...
      a = Context.a(paramTypedArray, paramXmlPullParser, paramTheme, "fillColor", 1, 0);
      mFillAlpha = Context.getNamedFloat(paramTypedArray, paramXmlPullParser, "fillAlpha", 12, mFillAlpha);
      mStrokeLineCap = getStrokeLineCap(Context.getString(paramTypedArray, paramXmlPullParser, "strokeLineCap", 8, -1), mStrokeLineCap);
      mStrokeLineJoin = getStrokeLineJoin(Context.getString(paramTypedArray, paramXmlPullParser, "strokeLineJoin", 9, -1), mStrokeLineJoin);
      mStrokeMiterlimit = Context.getNamedFloat(paramTypedArray, paramXmlPullParser, "strokeMiterLimit", 10, mStrokeMiterlimit);
      mStrokeColor = Context.a(paramTypedArray, paramXmlPullParser, paramTheme, "strokeColor", 3, 0);
      mStrokeAlpha = Context.getNamedFloat(paramTypedArray, paramXmlPullParser, "strokeAlpha", 11, mStrokeAlpha);
      mStrokeWidth = Context.getNamedFloat(paramTypedArray, paramXmlPullParser, "strokeWidth", 4, mStrokeWidth);
      mTrimPathEnd = Context.getNamedFloat(paramTypedArray, paramXmlPullParser, "trimPathEnd", 6, mTrimPathEnd);
      mTrimPathOffset = Context.getNamedFloat(paramTypedArray, paramXmlPullParser, "trimPathOffset", 7, mTrimPathOffset);
      mTrimPathStart = Context.getNamedFloat(paramTypedArray, paramXmlPullParser, "trimPathStart", 5, mTrimPathStart);
      mFillColor = Context.getString(paramTypedArray, paramXmlPullParser, "fillType", 13, mFillColor);
    }
    ...
    public void inflate(android.content.res.Resources paramResources, AttributeSet paramAttributeSet, Resources.Theme paramTheme, XmlPullParser paramXmlPullParser)
    {
      paramResources = Context.obtainAttributes(paramResources, paramTheme, paramAttributeSet, AndroidResources.ColorDrawable);
    ...
    extends x
  {
    ...
    final ArrayList<i.e> mChildren = new ArrayList();
    ...
    {
      mThemeAttrs = null;
      mRotate = Context.getNamedFloat(paramTypedArray, paramXmlPullParser, "rotation", 5, mRotate);
      mPivotX = paramTypedArray.getFloat(1, mPivotX);
      mPivotY = paramTypedArray.getFloat(2, mPivotY);
      mScaleX = Context.getNamedFloat(paramTypedArray, paramXmlPullParser, "scaleX", 3, mScaleX);
      mScaleY = Context.getNamedFloat(paramTypedArray, paramXmlPullParser, "scaleY", 4, mScaleY);
      mTranslateX = Context.getNamedFloat(paramTypedArray, paramXmlPullParser, "translateX", 6, mTranslateX);
      mTranslateY = Context.getNamedFloat(paramTypedArray, paramXmlPullParser, "translateY", 7, mTranslateY);
      paramTypedArray = paramTypedArray.getString(0);
      if (paramTypedArray != null) {
    ...
    public void inflate(android.content.res.Resources paramResources, AttributeSet paramAttributeSet, Resources.Theme paramTheme, XmlPullParser paramXmlPullParser)
    {
      paramResources = Context.obtainAttributes(paramResources, paramTheme, paramAttributeSet, AndroidResources.LayerDrawable);
  ...
  class VPathRenderer
  {
    ...
    Paint mStrokePaint;
    final a<String, Object> mVGTargetsMap = new Label();
    ...
    private void drawPath(VectorDrawableCompat.VGroup paramVGroup, VectorDrawableCompat.VPath paramVPath, Canvas paramCanvas, int paramInt1, int paramInt2, ColorFilter paramColorFilter)
    {
      ...
      if (mStrokeColor.a())
      {
        ...
        {
          paramVGroup.setColor(VectorDrawableCompat.access$getAlpha(((b)localObject1).getColor(), mStrokeAlpha));
        }
    ...
    extends Drawable.ConstantState
  {
    ...
    public Drawable newDrawable(android.content.res.Resources paramResources)
    {
      return new VectorDrawableCompat(this);
    }
  ...
  class VectorDrawableDelegateState
    extends Drawable.ConstantState
  {
    ...
    public Drawable newDrawable(android.content.res.Resources paramResources, Resources.Theme paramTheme)
    {
      VectorDrawableCompat localVectorDrawableCompat = new VectorDrawableCompat();
