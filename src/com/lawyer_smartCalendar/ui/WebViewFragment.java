...
import com.lawyer_smartCalendar.package_2.g;
  ...
  implements View.OnClickListener
{
  ...
  public void getTitle(Intent paramIntent)
  {
  ...
  {
    if (paramView.getId() != 2131296269) {
      return;
    }
    paramView = new Intent(getActivity(), AddCityBankAccountActivity.class);
  ...
  {
    return paramLayoutInflater.inflate(2131492973, paramViewGroup, false);
  }
  ...
  public void onCreateView()
  {
    ...
    localH.setEnabled();
    List localList = localH.c();
    localH.close();
    mRecyclerView.setAdapter(new g(getActivity(), this, localList));
  ...
  public void onCreateView(View paramView, Bundle paramBundle)
  {
    ...
    mFab = ((FloatingActionButton)paramView.findViewById(2131296269));
