...
import com.lawyer_smartCalendar.package_2.b;
import com.lawyer_smartCalendar.utils.h;
import java.util.List;

public class AbstractFilePickerFragment
  extends Fragment
  implements View.OnClickListener
{
  ...
  {
    return paramLayoutInflater.inflate(2131492974, paramViewGroup, false);
  }
  ...
  public void onCreateView()
  {
    ...
    localH.setEnabled();
    List localList = localH.next(getActivityc);
    localH.close();
    mRecyclerView.setAdapter(new b(getActivity(), this, localList));
  ...
  public void onCreateView(View paramView, Bundle paramBundle)
  {
    ...
    mRecyclerView = ((RecyclerView)paramView.findViewById(2131296681));
